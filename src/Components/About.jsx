  ...
  return (
    ...
    >
      <div className="Container max-w-[70rem] w-full h-[80%] md:h-full gap-10 md:gap-0 flex md:flex-row flex-col justify-between items-center">
        <div className="aboutme pr-10 w-full md:w-[50%] gap-2 flex flex-col items-start">
          <h1 className="text-4xl"><span className="border-t-4 border-main">A</span>bout me</h1>
          <p className="text-sm text-unactive">
            ...
            languages and technologies, including C, Java, JavaScript and
            React. I'm constantly looking for new projects
            to work on and possibilities to interact with other devs. I'm
            excited to grow as a developer, learn new things, and contribute to
            the tech sector.
          </p>
        </div>
        <div className="qualifications border-l-2 w-full md:w-[50%] gap-7 flex flex-col items-start">
          <h1 className="text-4xl pl-3"><span className="border-t-4 border-main">Q</span>ualifications</h1>
