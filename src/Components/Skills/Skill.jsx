...
export default function Skill({ title, purpose, logo }) {
  return (
    <motion.div
      ...
      className="flex hover:bg-active transition-all text-active hover:text-dark2 justify-start gap-2 border-[1px] rounded-2xl px-2 py-2 border-unactive items-center w-full md:w-48"
    >
