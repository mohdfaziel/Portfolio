  ...
  return (
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      <motion.div
        ...
        className="absolute -inset-x-10 top-0 m-auto h-2 w-10 rounded-full bg-gradient-to-r from-transparent via-yellow-400 to-transparent blur-sm"></motion.div>
      {spans.map((span) => (
        <motion.span
          key={span.id}
          ...
          className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-yellow-400 to-orange-500" />
      ))}
    </div>
  );
};
